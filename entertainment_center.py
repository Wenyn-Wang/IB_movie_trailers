...
wall_street = media.Movie("Wall Street (1987)",
                        ...
                        "http://ecx.images-amazon.com/images/I/51PSMDDFG1L.jpg",
...
margin_call = media.Movie("Margin Call",
                        ...
                        "http://resizing.flixster.com/zQEsRSKNDL-9x65czqmBcP-Xrrg=/800x1200/dkpu1ddg7pbsk.cloudfront.net/movie/11/17/77/11177758_ori.jpg",
...
capitalism_a_love_story = media.Movie("Capitalism: A Love Story",
                        ...
                        "http://ecx.images-amazon.com/images/I/71GSnvWC2GL._SL1500_.jpg",
                        "https://www.youtube.com/watch?v=CkTkYQkG13w")
...
barbarians_at_the_gate = media.Movie("Barbarians at the Gate",
                        ...
                        "https://upload.wikimedia.org/wikipedia/en/thumb/9/95/BarbariansAtTheGateDVDCover.jpg/250px-BarbariansAtTheGateDVDCover.jpg",
                        "https://www.youtube.com/watch?v=9FmcrpMO72Q")
...
the_big_short = media.Movie("The Big Short",
                        "Based on the book by Michael Lewis (writer of Moneyball, Liar's Poker and Flash Boys, among others), the true story of a handful of investors who bet against the US mortgage market in 2006-7.",
                        "http://cdn3-www.comingsoon.net/assets/uploads/gallery/the-big-short/tbs_1-sht_teaser.jpg",
...
wall_street_warriors = media.TvShow("Wall Street Warriors",
                        "season1, 2, 3",
                        "http://ecx.images-amazon.com/images/I/51uYlndI-IL.jpg",
                        "https://www.youtube.com/watch?v=nyRiuv4EDB4")

traders = media.TvShow("Traders",
                        "season1, 2, 3, 4, 5",
                        "http://www.gstatic.com/tv/thumb/tvbanners/184285/p184285_b_v8_ad.jpg",
